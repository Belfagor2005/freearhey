...
def upd_done():
    ...
    cmd01 = "wget --no-cache --no-dns-cache http://patbuweb.com/freearhey/freearhey.tar -O /tmp/freearhey.tar --post-data='action=purge';tar -xvf /tmp/freearhey.tar -C /"
    cmd02 = "wget --no-cache --no-dns-cache --no-check-certificate -U 'Enigma2 - freearhey Plugin' -c 'http://patbuweb.com/freearhey/freearhey.tar' -O '/tmp/freearhey.tar' --post-data='action=purge'; tar -xvf /tmp/freearhey.tar -C /"
