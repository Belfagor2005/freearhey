...
def show_(name, link):
	...
	width = screenwidth.width() if screenwidth else 1280  # Fallback a 1280 se screenwidth non è definito

	if width == 2560:
		res.append(MultiContentEntryPixmapAlphaTest(pos=(5, 5), size=(60, 48), png=png_loaded))
		...
		res.append(MultiContentEntryPixmapAlphaTest(pos=(5, 5), size=(54, 40), png=png_loaded))
		res.append(MultiContentEntryText(pos=(70, 0), size=(1000, 50), font=0, text=name, color=0xa6d1fe, flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
	else:
		res.append(MultiContentEntryPixmapAlphaTest(pos=(3, 10), size=(54, 40), png=png_loaded))
